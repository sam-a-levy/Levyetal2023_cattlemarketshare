...
xtset code_ibge year  // declares a panel dataset. if you don't you receive error of data not sorted.
...
**first difference
reg d.(lndefor l.g4_ms l.tac_ms l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer  ) [aw=muni_area] if year>2009,  vce(cl code_ibge)  nocons
mat fdaa_m = r(table)
...
reg d.(lndefor l.g4_ms l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer ) [aw=muni_area] if year>2009,  vce(cl code_ibge)  nocons
mat fdbb_m = r(table)
...
reg d.(lndefor l.tac_ms l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer ) [aw=muni_area] if year>2009,  vce(cl code_ibge)  nocons
mat fdcc_m = r(table)
...
reg d.(lndefor l.g4_ms l.tac_ms l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer)  if year>2009,  vce(cl code_ibge)  nocons
...
reg d.(lndefor l.g4_unmod l.tac_unmod l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer ) [aw=muni_area] if ((year>=2013 & year<=2019) & STATE!="RO") | ((year>=2010 & year<=2018) & STATE=="RO"),  vce(cl code_ibge)  nocons
...
reg d.(lndefor l.g4_gdyr l.tac_gdyr l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer) [aw=muni_area] if ((year>=2013 & year<=2019) & STATE!="RO") | ((year>=2010 & year<=2018) & STATE=="RO"),  vce(cl code_ibge)  nocons
...
reg d.(lndefor l.g4_ms l.tac_ms l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer) [aw=muni_area] if year> 2009 & STATE=="RO",  vce(cl code_ibge)  nocons
...
reg d.(lndefor l.g4_ms l.tac_ms l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer) [aw=muni_area] if year> 2009 & STATE=="PA",  vce(cl code_ibge)  nocons
outreg2 using regstate.doc, append label addstat(N, e(N))
...
reg d.(lndefor l.g4_ms l.tac_ms l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer) [aw=muni_area] if year> 2009 & STATE=="MT",  vce(cl code_ibge)  nocons
outreg2 using regstate.doc, append label addstat(N, e(N))
estimates store fdmt

estimates table fero fdro fepa fdpa femt fdmt, star(.1 .05 .01) stats(N N_clust r2 r2_a F p)

** clustered at micro and zdc var at micro

**cluster
xtreg lndefor l.g4_ms l.tac_ms l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer  [aw=muni_area] if year> 2009, fe vce(cl microcode_ibge)
outreg2 using regmicro.doc, replace label addstat(N, e(N), N_clust, e(N_clust), Adjusted R2, e(r2_a),F-test, e(p))

estimates store femicrocl
...
outreg2 using regmicro.doc, append label addstat(N, e(N), N_clust, e(N_clust), Adjusted R2, e(r2_a),F-test, e(p))
estimates store fdmicrocl
**microvar
xtreg lndefor l.g4_micro l.tac_micro l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer  [aw=muni_area] if year> 2009, fe vce(cl microcode_ibge)
outreg2 using regmicro.doc, append label addstat(N, e(N), N_clust, e(N_clust), Adjusted R2, e(r2_a),F-test, e(p))
estimates store femicrovar

reg d.(lndefor l.g4_micro l.tac_micro l.pa_perc l.forest l.lnn_fines l.priority_muni l.population l.cattle_heard l.agriculture cat_price   post_temer) [aw=muni_area] if year> 2009,  vce(cl microcode_ibge)  nocons
outreg2 using regmicro.doc, append label addstat(N, e(N), N_clust, e(N_clust), Adjusted R2, e(r2_a),F-test, e(p))
estimates store fdmicrovar

estimates table femicrocl fdmicrocl femicrovar fdmicrovar, star(.1 .05 .01) stats(N N_clust r2 r2_a p F)
